...
class UsuarioRepositoryTest {
  ...
  @Test
  @DisplayName(
      "Case 1: Should get user successfully from database.") // Coloca uma descrição para o teste
  void findByLoginSuccess() {
    ...
    Optional<Usuario> usuarioEncontrado =
        this.usuarioRepository.findByLogin(novoUsuario.getLogin());
  ...
  @Test
  @DisplayName(
      "Case 2: Should not get user successfully from database when user not exists.") // Coloca uma
  // descrição
  // para o
  // teste

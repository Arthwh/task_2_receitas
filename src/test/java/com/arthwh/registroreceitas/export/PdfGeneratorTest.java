...
class PdfGeneratorTest {
  ...
  @Test
  @DisplayName(
      "Case 1: Should generate the pdf file successfully with the recipe data that was sent to the method.")
  void generatePdfStream_ComSucesso() throws Exception {
    ...
    assertTrue(
        outputStream.toByteArray().length > 0, "O arquivo PDF gerado não deveria estar vazio");
  ...
  @Test
  @DisplayName(
      "Case 3: Should generate the pdf file successfylly and don't throw an NullPointerException.")
  void generatePdfStream_ComReceitaComCamposNulos() throws Exception {
    ...
    ByteArrayOutputStream outputStream =
        assertDoesNotThrow(() -> pdfGenerator.generatePdfStream(receitas));
